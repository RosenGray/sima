...
const HandymanIcon = ({ width, height, viewBox = { width: 100, height: 100 } }: HandymanIconProps) => {
  ...
  <defs>
    ...
    >
      ...
      <stop offset="1" stop-color="#3b82f6" stop-opacity="0.12" />
    </linearGradient>
  </defs>
  ...
  <rect
    ...
    stroke-width="0.8"
  />
  <path d="M60 72 L60 90" stroke="#2563eb" stroke-width="1" opacity="0.5" />
  <path d="M35 80 L85 80" stroke="#2563eb" stroke-width="1" opacity="0.5" />
  <rect
    x="22"
    y="31"
    width="16"
  ...
  <rect
    ...
    stroke-width="1.2"
  />
  <path d="M28 40 L32 40" stroke="#78350f" stroke-width="1" opacity="0.5" />
  <path d="M28 46 L32 46" stroke="#78350f" stroke-width="1" opacity="0.5" />
  <path d="M28 52 L32 52" stroke="#78350f" stroke-width="1" opacity="0.5" />
  <path d="M28 58 L32 58" stroke="#78350f" stroke-width="1" opacity="0.5" />
  <path d="M28 64 L32 64" stroke="#78350f" stroke-width="1" opacity="0.5" />
  <rect
    x="24"
    y="33"
    width="10"
  ...
  <circle
    ...
    stroke-width="1"
  />
  <path d="M53.5 62 L56.5 62" stroke="#64748b" stroke-width="1" />
  <rect
    x="40"
    y="75"
    width="15"
    ...
    stroke-width="0.8"
  />
  <path d="M41.0 75 L41.0 76.5" stroke="#92400e" stroke-width="0.5" />
  <path d="M43.5 75 L43.5 76.5" stroke="#92400e" stroke-width="0.5" />
  <path d="M46.0 75 L46.0 76.5" stroke="#92400e" stroke-width="0.5" />
  <path d="M48.5 75 L48.5 76.5" stroke="#92400e" stroke-width="0.5" />
  <path d="M51.0 75 L51.0 76.5" stroke="#92400e" stroke-width="0.5" />
  <path d="M53.5 75 L53.5 76.5" stroke="#92400e" stroke-width="0.5" />
  <path
