...
const TruckIcon = ({ width, height, viewBox = { width: 100, height: 100 } }: TruckIconProps) => {
  return (
    <svg
    ...
    >
      ...
      <path
        d="M65 52 L92 52 L94 62 L94 70 L65 70 Z"
        fill="url(#truckBodyGrad)"
        stroke="#1a3a1b"
        strokeWidth="1.5"
      />
      <path
        d="M25 68 L28 54 L35 48 L45 43 L60 43 L65 48 L65 70 L25 70 Z"
        fill="url(#truckBodyGrad)"
        stroke="#1a3a1b"
        strokeWidth="1.5"
      />
      <path
        d="M38 43 L42 35 L58 35 L62 43 Z"
        fill="url(#truckBodyGrad)"
        stroke="#1a3a1b"
        strokeWidth="1.5"
      />
      <path
        d="M40 41 L43 37 L52 37 L52 41 Z"
        fill="url(#truckWindowGrad)"
        stroke="#2196f3"
        strokeWidth="1"
      />
      <path
        d="M54 37 L58 37 L60 41 L54 41 Z"
        fill="url(#truckWindowGrad)"
        stroke="#2196f3"
        strokeWidth="1"
      />
