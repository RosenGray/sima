...
const SimaLightIcon = ({
  ...
  return (
    ...
    >
      ...
      <ellipse cx="60" cy="88" rx="40" ry="3" fill="#000000" opacity="0.15" />
      <path
      ...
      <circle
        ...
        strokeWidth="1.5"
      />
      <circle cx="83" cy="62" r="5" fill="#ffffff" />
      <rect
        x="88"
        y="54"
        width="4"
      ...
      <path
        ...
        opacity="0.6"
      />
      <circle cx="12" cy="25" r="1.2" fill="#f472b6" opacity="0.6" />
      <circle cx="17" cy="25" r="1.2" fill="#f472b6" opacity="0.6" />
      <circle cx="22" cy="25" r="1.2" fill="#f472b6" opacity="0.6" />
      <path d="M20 48 L85 48 L83 52 L22 52 Z" fill="#ffffff" opacity="0.3" />
    </svg>
  );
};

export default SimaLightIcon;
