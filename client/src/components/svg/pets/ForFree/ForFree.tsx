...
const ForFreeIcon = ({ width, height, viewBox = { width: 100, height: 100 } }: ForFreeIconProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox={`0 0 ${viewBox?.width} ${viewBox?.height}`} fill="none">
            ...
            <circle cx="35" cy="52" r="15" fill="url(#dogGrad)" stroke="#f59e0b" strokeWidth="1.5" />
            <path d="M25 44 C23 46 21 52 23 56 C25 54 27 50 27 46 Z" fill="#fbbf24" stroke="#f59e0b" strokeWidth="1" />
            <path d="M45 44 C47 46 49 52 47 56 C45 54 43 50 43 46 Z" fill="#fbbf24" stroke="#f59e0b" strokeWidth="1" />
            <ellipse cx="35" cy="57" rx="8" ry="6" fill="#fef3c7" stroke="#f59e0b" strokeWidth="0.8" />
            ...
            <ellipse cx="35" cy="56" rx="2" ry="1.5" fill="#1f2937" stroke="#111827" strokeWidth="0.5" />
            <path d="M31 58 C33 60 37 60 39 58" fill="none" stroke="#f59e0b" strokeWidth="1.2" />
            <ellipse cx="35" cy="60" rx="1.5" ry="2" fill="#f87171" stroke="#dc2626" strokeWidth="0.5" />
            <circle cx="85" cy="52" r="13" fill="url(#catGrad)" stroke="#7c3aed" strokeWidth="1.5" />
            <path d="M77 42 L74 36 L80 40 Z" fill="#a78bfa" stroke="#7c3aed" strokeWidth="1" />
            <path d="M77 41 L76 38 L79 40 Z" fill="#f9a8d4" stroke="none" />
            <path d="M93 42 L96 36 L90 40 Z" fill="#a78bfa" stroke="#7c3aed" strokeWidth="1" />
            ...
            <path d="M85 54 L83.5 52 L86.5 52 Z" fill="#f9a8d4" stroke="#ec4899" strokeWidth="0.5" />
            <path d="M85 54 L85 56" fill="none" stroke="#7c3aed" strokeWidth="1" />
            <path d="M85 56 C83 57 81 56 80 55" fill="none" stroke="#7c3aed" strokeWidth="1" />
            <path d="M85 56 C87 57 89 56 90 55" fill="none" stroke="#7c3aed" strokeWidth="1" />
            <path d="M79 50.0 L73 49.0" stroke="#7c3aed" strokeWidth="0.5" />
            <path d="M79 51.5 L73 50.5" stroke="#7c3aed" strokeWidth="0.5" />
            <path d="M79 53.0 L73 52.0" stroke="#7c3aed" strokeWidth="0.5" />
            <path d="M91 50.0 L97 49.0" stroke="#7c3aed" strokeWidth="0.5" />
            <path d="M91 51.5 L97 50.5" stroke="#7c3aed" strokeWidth="0.5" />
            <path d="M91 53.0 L97 52.0" stroke="#7c3aed" strokeWidth="0.5" />
            ...
            <circle cx="60" cy="22" r="14" fill="url(#badgeGrad)" stroke="#059669" strokeWidth="2" />
            <circle cx="60" cy="22" r="11" fill="none" stroke="#ffffff" strokeWidth="1.5" />
            ...
            <path d="M60 88 C50 76 50 72 55 72 C58 74 60 76 60 78 C60 76 62 74 65 72 C70 72 70 76 60 88 Z" fill="url(#heartGrad)" stroke="#db2777" strokeWidth="2" />
            <ellipse cx="58" cy="76" rx="2" ry="3" fill="#ffffff" opacity="0.4" />
            <path d="M45 74 C42 71 42 70 43.5 70 C45 70.5 45 71 45 72 C45 71 45 70.5 46.5 70 C48 70 48 71 45 74 Z" fill="#ec4899" stroke="#db2777" strokeWidth="0.8" opacity="0.6" />
            <path d="M75 72 C72 69 72 68 73.5 68 C75 68.5 75 69 75 70 C75 69 75 68.5 76.5 68 C78 68 78 69 75 72 Z" fill="#ec4899" stroke="#db2777" strokeWidth="0.8" opacity="0.6" />
            <path d="M30 42 C27 39 27 38 28.5 38 C30 38.5 30 39 30 40 C30 39 30 38.5 31.5 38 C33 38 33 39 30 42 Z" fill="#ec4899" stroke="#db2777" strokeWidth="0.8" opacity="0.6" />
            <path d="M90 44 C87 41 87 40 88.5 40 C90 40.5 90 41 90 42 C90 41 90 40.5 91.5 40 C93 40 93 41 90 44 Z" fill="#ec4899" stroke="#db2777" strokeWidth="0.8" opacity="0.6" />
            ...
            <path d="M25 58.5 L25.45 59.55 L26.5 60 L25.45 60.45 L25 61.5 L24.55 60.45 L23.5 60 L24.55 59.55 Z" fill="#fbbf24" stroke="#f59e0b" strokeWidth="0.5" opacity="0.6" />
            <path d="M95 60.7 L95.39 61.61 L96.3 62 L95.39 62.39 L95 63.3 L94.61 62.39 L93.7 62 L94.61 61.61 Z" fill="#fbbf24" stroke="#f59e0b" strokeWidth="0.5" opacity="0.6" />
            <path d="M60 38.8 L60.36 39.64 L61.2 40 L60.36 40.36 L60 41.2 L59.64 40.36 L58.8 40 L59.64 39.64 Z" fill="#fbbf24" stroke="#f59e0b" strokeWidth="0.5" opacity="0.6" />
        </svg>
    );
};
