...
const AccessoriesIcon = ({ width, height, viewBox = { width: 100, height: 100 } }: AccessoriesIconProps) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox={`0 0 ${viewBox?.width} ${viewBox?.height}`} fill="none">
            ...
            <circle cx="60" cy="30" r="18" fill="none" stroke="url(#collarGrad)" strokeWidth="5" />
            <rect x="75" y="27" width="5" height="6" rx="1" fill="#9ca3af" stroke="#6b7280" strokeWidth="1" />
            <circle cx="77.5" cy="30" r="1.5" fill="#4b5563" />
            <circle cx="60" cy="45" r="2" fill="none" stroke="#9ca3af" strokeWidth="1.5" />
            <path d="M56 48 C56 46 57 45 58 45 L62 45 C63 45 64 46 64 48 C64 50 63 51 62 51 L58 51 C57 51 56 50 56 48 Z" fill="#d1d5db" stroke="#9ca3af" strokeWidth="1.5" />
            ...
            <path d="M20 75 L23 85 C25 87 30 88 35 88 C40 88 45 87 47 85 L50 75 Z" fill="url(#bowlGrad)" stroke="#2563eb" strokeWidth="2" />
            <ellipse cx="35" cy="75" rx="15" ry="4" fill="#93c5fd" stroke="#2563eb" strokeWidth="1.5" />
            ...
            <circle cx="85" cy="75" r="12" fill="url(#ballGrad)" stroke="#f59e0b" strokeWidth="2" />
            <path d="M77 72 C81 69 89 69 93 72" fill="none" stroke="#ffffff" strokeWidth="2" />
            <path d="M77 78 C81 81 89 81 93 78" fill="none" stroke="#ffffff" strokeWidth="2" />
            <circle cx="81" cy="71" r="3" fill="#ffffff" opacity="0.4" />
            <path d="M15 50 C13 48 13 47 15 47 C17 47 17 48 18 50 L32 50 C33 48 33 47 35 47 C37 47 37 48 35 50 C37 52 37 53 35 53 C33 53 33 52 32 50 L18 50 C17 52 17 53 15 53 C13 53 13 52 15 50 Z" fill="url(#boneGrad)" stroke="#f59e0b" strokeWidth="1.5" />
            ...
            <ellipse cx="95" cy="50" rx="5" ry="7" fill="#9ca3af" stroke="#6b7280" strokeWidth="1" />
            <circle cx="92" cy="45" r="2.5" fill="#f9a8d4" stroke="#ec4899" strokeWidth="0.8" />
            <circle cx="98" cy="45" r="2.5" fill="#f9a8d4" stroke="#ec4899" strokeWidth="0.8" />
            <circle cx="93" cy="49" r="0.8" fill="#1f2937" />
            <circle cx="97" cy="49" r="0.8" fill="#1f2937" />
            <circle cx="95" cy="51" r="0.8" fill="#ec4899" />
            <path d="M95 57 C98 60 100 62 102 60" fill="none" stroke="#6b7280" strokeWidth="1.5" />
            <path d="M42 25 C15 45 20 55 35 45" fill="none" stroke="#1e40af" strokeWidth="2.5" opacity="0.4" />
            <rect x="40" y="23" width="3" height="4" rx="0.5" fill="#9ca3af" stroke="#6b7280" strokeWidth="0.8" />
            ...
            <path d="M48 23.5 L48.45 24.55 L49.5 25 L48.45 25.45 L48 26.5 L47.55 25.45 L46.5 25 L47.55 24.55 Z" fill="#fbbf24" stroke="#f59e0b" strokeWidth="0.5" opacity="0.6" />
            <path d="M72 26.7 L72.39 27.61 L73.3 28 L72.39 28.39 L72 29.3 L71.61 28.39 L70.7 28 L71.61 27.61 Z" fill="#fbbf24" stroke="#f59e0b" strokeWidth="0.5" opacity="0.6" />
            <path d="M60 86.8 L60.36 87.64 L61.2 88 L60.36 88.36 L60 89.2 L59.64 88.36 L58.8 88 L59.64 87.64 Z" fill="#fbbf24" stroke="#f59e0b" strokeWidth="0.5" opacity="0.6" />
        </svg>
    );
};
