...
const realEstateForSaleSchema = new mongoose.Schema(
  {
    publicId: {
      type: String,
      required: true,
...
realEstateForSaleSchema.index({
  description: "text",
  streetname: "text",
});

export const RealEstateForSale =
  mongoose.models.RealEstateForSale ||
  mongoose.model<IRealEstateForSale>(
    "RealEstateForSale",
    realEstateForSaleSchema
  );
