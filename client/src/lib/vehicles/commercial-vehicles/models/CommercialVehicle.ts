...
export const COMMERCIAL_VEHICLE_STATUSES = [
  "active",
  "expired",
  "archived",
  "deleted",
...
export type CommercialVehicleStatus = (typeof COMMERCIAL_VEHICLE_STATUSES)[number];

export interface ICommercialVehicle {
  id: string;
  publicId: string;
...
const commercialVehicleSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: COMMERCIAL_VEHICLE_STATUSES,
      default: "active",
      required: true,
      index: true,
    },
...
export const CommercialVehicle =
  mongoose.models.CommercialVehicle ||
  mongoose.model<ICommercialVehicle>("CommercialVehicle", commercialVehicleSchema);
