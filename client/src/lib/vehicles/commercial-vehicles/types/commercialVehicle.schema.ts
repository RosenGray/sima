...
export const createCommercialVehicleSchema = ({ minNumberOfImages = 1 }) => {
  return z.object({
...
export type CommercialVehicleFormData = z.infer<
  ReturnType<typeof createCommercialVehicleSchema>
>;
