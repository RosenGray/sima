...
import { MotorcycleKind } from "./motorcycle.types";
...
export const createMotorcycleSchema = ({ minNumberOfImages = 1 }) => {
  return z.object({
    ...
    kind: z.nativeEnum(MotorcycleKind, {
      required_error: "Выберите тип мотоцикла",
    }),
    mileage: z.coerce
      .number({
...
export type MotorcycleFormData = z.infer<
  ReturnType<typeof createMotorcycleSchema>
>;
