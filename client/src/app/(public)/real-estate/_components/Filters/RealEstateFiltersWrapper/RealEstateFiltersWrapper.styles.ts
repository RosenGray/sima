...
export const RealEstateFiltersContainer = styled.div<{ $isModalOpen: boolean }>`
...
export const RealEstateFiltersHeader = styled.header`
  height: 50px;
  flex-shrink: 0;
...
export const RealEstateFiltersContent = styled.div`
  flex: 1;
  display: flex;
  flex-direction: column;
  min-height: 0;
