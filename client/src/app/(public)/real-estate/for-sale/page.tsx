...
import { RealEstateForSalePageContainer } from "./page.styles";
import RealEstateForSaleContent from "./_components/RealEstateForSaleContent/RealEstateForSaleContent";
...
import { RealEstateForSaleSearchFilters } from "@/lib/real-estate/for-sale/repository/RealEstateForSaleRepository";
...
const RealEstateForSalePage: FC<RealEstateForSalePageProps> = async (props) => {
  ...
  const filters: RealEstateForSaleSearchFilters = {
  ...
  return (
    <RealEstateForSalePageContainer>
      ...
      <Suspense key={contentKey} fallback={<Loading />}>
        <RealEstateForSaleContent filters={filters} currentPage={currentPage} />
      </Suspense>
    </RealEstateForSalePageContainer>
  );
};
