...
import {
  ...
  Furniture,
  EntryDate,
} from "@/lib/real-estate/for-sale/types/realEstateForSale.types";
...
import {
  ...
  HeaderSection,
  ButtonGroup,
} from "./RealEstateForSaleDetailClient.styles";
import { useAuth } from "@/providers/AuthProvider/AuthProvider";
import {
  deleteRealEstateForSaleAdWithRedirect,
} from "@/lib/real-estate/for-sale/actions/deleteRealEstateForSaleAd";
        ...
        {isOwner && (
          <ButtonGroup>
            <Button disabled={isPending} asChild size="3" variant="soft">
              <Link
                color="yellow"
                href={`/publish-ad/real-estate/for-sale/edit/${publicId}`}
              >
...
export default RealEstateForSaleDetailClient;
