...
import { RealEstateForSaleFilter, RealEstateForSaleFilterSchema } from "./filters.types";
...
const ENTITY_TYPE = ENTITY_TYPE_REAL_ESTATE_FOR_SALE;
...
const FiltersClient: FC = () => {
  ...
  const handleSubmitAllFilters = useCallback(() => {
    ...
    const parseResult = parseWithZod(formData, {
      schema: RealEstateForSaleFilterSchema,
    });
    const schemaKeys = Object.keys(RealEstateForSaleFilterSchema.shape);
    ...
    if (parseResult.status === "success") {
      ...
      schemaKeys.forEach((key) => {
        ...
        const value = values[key as keyof RealEstateForSaleFilter];
