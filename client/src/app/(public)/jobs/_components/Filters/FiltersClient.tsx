...
import { JobFilter, JobFilterSchema } from "./filters.types";
...
const FiltersClient: FC = () => {
  ...
  const handleSubmitAllFilters = useCallback(() => {
    ...
    const parseResult = parseWithZod(formData, { schema: JobFilterSchema });
    const schemaKeys = Object.keys(JobFilterSchema.shape);
    ...
    if (parseResult.status === "success") {
      ...
      schemaKeys.forEach((key) => {
        ...
        const value = values[key as keyof JobFilter];
