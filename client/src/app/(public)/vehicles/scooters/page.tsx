...
import { ScootersPageContainer } from "./page.styles";
import ScootersContent from "./_components/ScootersContent/ScootersContent";
...
import { ScooterSearchFilters } from "@/lib/vehicles/scooters/repository/ScooterRepository";
...
const ScootersPage: FC<ScootersPageProps> = async (props) => {
  ...
  const filters: ScooterSearchFilters = {
  ...
  return (
    <ScootersPageContainer>
      ...
      <Suspense key={contentKey} fallback={<Loading />}>
        <ScootersContent filters={filters} currentPage={currentPage} view={view} />
      </Suspense>
    </ScootersPageContainer>
  );
};
