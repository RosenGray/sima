...
import {
  ...
  HeaderSection,
  ButtonGroup,
} from "./ScooterDetailClient.styles";
import { useAuth } from "@/providers/AuthProvider/AuthProvider";
import { deleteScooterAdWithRedirect } from "@/lib/vehicles/scooters/actions/deleteScooterAd";
...
const ScooterDetailClient: React.FC<ScooterDetailClientProps> = ({ scooter }) => {
  ...
  const isOwner = thisUserIsOwner(scooter.user.id);
        ...
        {isOwner && (
          <ButtonGroup>
            <Button disabled={isPending} asChild size="3" variant="soft">
              <Link
                color="yellow"
                href={`/publish-ad/vehicles/scooters/edit/${publicId}`}
              >
...
export default ScooterDetailClient;
