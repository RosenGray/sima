...
import {
  ...
  HeaderSection,
  ButtonGroup,
} from "./MotorcycleDetailClient.styles";
import { useAuth } from "@/providers/AuthProvider/AuthProvider";
import { deleteMotorcycleAdWithRedirect } from "@/lib/vehicles/motorcycles/actions/deleteMotorcycleAd";
...
const MotorcycleDetailClient: React.FC<MotorcycleDetailClientProps> = ({
  ...
  const isOwner = thisUserIsOwner(motorcycle.user.id);
        ...
        {isOwner && (
          <ButtonGroup>
            <Button disabled={isPending} asChild size="3" variant="soft">
              <Link
                color="yellow"
                href={`/publish-ad/vehicles/motorcycles/edit/${publicId}`}
              >
...
export default MotorcycleDetailClient;
