...
interface OffRoadVehiclesHeaderClientProps {
  totalCount: number;
}

const OffRoadVehiclesHeaderClient: FC<OffRoadVehiclesHeaderClientProps> = ({
  totalCount,
}) => {
...
export default OffRoadVehiclesHeaderClient;
