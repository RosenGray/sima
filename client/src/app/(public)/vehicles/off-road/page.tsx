...
import { OffRoadVehiclesPageContainer } from "./page.styles";
import OffRoadVehiclesContent from "./_components/OffRoadVehiclesContent/OffRoadVehiclesContent";
...
import { OffRoadVehicleSearchFilters } from "@/lib/vehicles/off-road/repository/OffRoadVehicleRepository";

interface OffRoadVehiclesPageProps {
...
const OffRoadVehiclesPage: FC<OffRoadVehiclesPageProps> = async (props) => {
  ...
  const filters: OffRoadVehicleSearchFilters = {
