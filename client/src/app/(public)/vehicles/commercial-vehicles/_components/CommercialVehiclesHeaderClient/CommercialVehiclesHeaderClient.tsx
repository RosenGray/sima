...
interface CommercialVehiclesHeaderClientProps {
  totalCount: number;
}

const CommercialVehiclesHeaderClient: FC<CommercialVehiclesHeaderClientProps> = ({
  totalCount,
}) => {
...
export default CommercialVehiclesHeaderClient;
