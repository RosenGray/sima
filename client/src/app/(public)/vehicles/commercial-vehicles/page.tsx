...
import { CommercialVehiclesPageContainer } from "./page.styles";
import CommercialVehiclesContent from "./_components/CommercialVehiclesContent/CommercialVehiclesContent";
...
import { CommercialVehicleSearchFilters } from "@/lib/vehicles/commercial-vehicles/repository/CommercialVehicleRepository";

interface CommercialVehiclesPageProps {
...
const CommercialVehiclesPage: FC<CommercialVehiclesPageProps> = async (props) => {
  ...
  return (
    <CommercialVehiclesPageContainer>
      ...
      <Suspense key={contentKey} fallback={<Loading />}>
        <CommercialVehiclesContent filters={filters} currentPage={currentPage} view={view} />
      </Suspense>
    </CommercialVehiclesPageContainer>
  );
};
