...
import {
  ...
  HeaderSection,
  ButtonGroup,
} from "./OthersDetailClient.styles";
import { useAuth } from "@/providers/AuthProvider/AuthProvider";
import { deleteOthersAdWithRedirect } from "@/lib/other/actions/deleteOthersAd";
...
const OthersDetailClient: React.FC<OthersDetailClientProps> = ({ others }) => {
  ...
  const isOwner = thisUserIsOwner(others.user.id);
        ...
        {isOwner && (
          <ButtonGroup>
            <Button disabled={isPending} asChild size="3" variant="soft">
              <Link
                color="yellow"
                href={`/publish-ad/other/edit/${publicId}`}
              >
...
export default OthersDetailClient;
