...
const ENTITY_TYPE = ENTITY_TYPE_PETS_ACCESSORIES;
...
const FiltersClient: FC = () => {
  ...
  const handleSubmitAllFilters = useCallback(() => {
    ...
    const parseResult = parseWithZod(formData, {
      schema: PetAccessoryFilterSchema,
    });
    const schemaKeys = Object.keys(PetAccessoryFilterSchema.shape);
    ...
    if (parseResult.status === "success") {
      ...
      schemaKeys.forEach((key) => {
        ...
        const value = values[key as keyof PetAccessoryFilter];
