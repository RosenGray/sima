...
} from "@/lib/yad2/types/yad2.schema";
...
import { publishYad2ItemAd } from "@/lib/yad2/actions/publishYad2ItemAd";
import { editYad2ItemAd } from "@/lib/yad2/actions/editYad2ItemAd";
...
import {
  ...
  HeroCard,
  SectionCard,
} from "./Yad2ItemPublishForm.styles";
import { mapYad2CategoriesToSelectOptions } from "@/lib/yad2/yad2Categories";
import {
  getYad2SubCategoriesToSelectOptions,
...
interface Yad2ItemPublishFormProps {
  yad2Item?: SerializedYad2Item;
  formMode: FormMode;
}

const Yad2ItemPublishForm: FC<Yad2ItemPublishFormProps> = ({
  yad2Item,
  formMode,
}) => {
  ...
  const updateYad2ItemWithImagesToDelete = editYad2ItemAd.bind(null, {
    yad2ItemPublicId: yad2Item?.publicId as string,
    imagesToDelete,
    allImagesShouldBeDeleted,
  });

  const [formState, formAction, isPending] = useActionState(
    isCreateMode ? publishYad2ItemAd : updateYad2ItemWithImagesToDelete,
    undefined
  );

  const [form, fields] = useForm({
    defaultValue: {
      category: yad2Item?.category || "",
      subCategory: yad2Item?.subCategory || "",
      productTitle: yad2Item?.productTitle || "",
      price: yad2Item?.price?.toString() || "",
      description: yad2Item?.description || "",
      district: yad2Item?.district || Districts.Center,
      city: yad2Item?.city || "",
      contactName: yad2Item?.contactName || "",
      contactPrimaryPhone: yad2Item?.contactPrimaryPhone || "",
      contactSecondaryPhone: yad2Item?.contactSecondaryPhone || "",
      contactEmail: yad2Item?.contactEmail || user?.email || "",
      acceptTerms: yad2Item?.acceptTerms ? "on" : null,
      images: [],
    },
  ...
  const subCategoryOptions = useMemo(
    () =>
      category.value
        ? getYad2SubCategoriesToSelectOptions(category.value as string)
        : [],
    [category.value]
  );
              ...
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Укажите категорию, подкатегорию и название товара.
                  </Text>
                </Box>
                <Grid
                ...
                >
                  ...
                  <BasicFormField
                    ...
                    size="3"
                    defaultValue={productTitle.initialValue}
                    dataIsValid={productTitle.valid}
            ...
            <SectionCard variant="surface" size="4">
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Укажите цену и подробное описание товара.
                  </Text>
                </Box>
                <Grid
                  columns={{ initial: "1", md: "2" }}
            ...
            <SectionCard variant="surface" size="4">
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Укажите район и город, где находится товар.
                  </Text>
                </Box>
                <Grid
                  columns={{ initial: "1", md: "2" }}
...
export default Yad2ItemPublishForm;
