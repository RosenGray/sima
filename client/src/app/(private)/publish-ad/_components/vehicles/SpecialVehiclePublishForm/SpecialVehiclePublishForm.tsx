...
} from "@/lib/vehicles/special-vehicles/types/specialVehicle.schema";
...
import { publishSpecialVehicleAd } from "@/lib/vehicles/special-vehicles/actions/publishSpecialVehicleAd";
import { editSpecialVehicleAd } from "@/lib/vehicles/special-vehicles/actions/editSpecialVehicleAd";
...
import {
  ...
  HeroCard,
  SectionCard,
} from "./SpecialVehiclePublishForm.styles";
...
interface SpecialVehiclePublishFormProps {
  entity?: SerializedSpecialVehicle;
  formMode: FormMode;
}

const SpecialVehiclePublishForm: FC<SpecialVehiclePublishFormProps> = ({
  entity,
  formMode,
}) => {
  ...
  const updateSpecialVehicleWithImagesToDelete = editSpecialVehicleAd.bind(
    null,
    {
      specialVehiclePublicId: entity?.publicId as string,
      imagesToDelete,
  ...
  const [formState, formAction, isPending] = useActionState(
    isCreateMode
      ? publishSpecialVehicleAd
      : updateSpecialVehicleWithImagesToDelete,
    undefined
  );
  ...
  const kindOptions = useMemo(
    () =>
      category.value
        ? getSpecialVehicleKindsToSelectOptions(category.value as string)
        : [],
    [category.value]
  );
              ...
              >
                <Box>
                  <Heading as="h1" size={{ initial: "6", md: "7" }}>
                    Расскажите о вашем специальном транспортном средстве
                  </Heading>
                  <Text
                    mt="2"
                    size={{ initial: "3", md: "4" }}
              ...
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Укажите категорию, вид и название транспортного средства.
                  </Text>
                </Box>
                <Grid
            ...
            <SectionCard variant="surface" size="4">
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Укажите цену и подробное описание транспортного средства.
                  </Text>
                </Box>
                <Grid
                  columns={{ initial: "1", md: "2" }}
                ...
                <TextAreaField
                  field={description}
                  label="Описание:"
                  placeholder="Опишите транспортное средство..."
                  size="3"
            ...
            <SectionCard variant="surface" size="4">
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Укажите район и город, где находится транспортное средство.
                  </Text>
                </Box>
                <Grid
                  columns={{ initial: "1", md: "2" }}
            ...
            <SectionCard variant="surface" size="4">
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Добавьте изображения транспортного средства.
...
export default SpecialVehiclePublishForm;
