...
} from "@/lib/pets/for-sale/types/petForSale.schema";
...
import { publishPetForSaleAd } from "@/lib/pets/for-sale/actions/publishPetForSaleAd";
import { editPetForSaleAd } from "@/lib/pets/for-sale/actions/editPetForSaleAd";
...
import {
  ...
  HeroCard,
  SectionCard,
} from "./PetForSalePublishForm.styles";
import {
...
// Map PetGender enum to select options
// Filter out string keys (numeric enums have reverse mapping)
...
// Map PetAge enum to select options
// Filter out string keys (numeric enums have reverse mapping)
...
const PetForSalePublishForm: FC<PetForSalePublishFormProps> = ({
  pet,
  formMode,
}) => {
  ...
  const updatePetWithImagesToDelete = editPetForSaleAd.bind(null, {
            ...
            <SectionCard variant="surface" size="4">
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Укажите цену и подробное описание питомца.
                  </Text>
                </Box>
                <Grid
                  columns={{ initial: "1", md: "2" }}
...
export default PetForSalePublishForm;
