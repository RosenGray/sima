...
} from "@/lib/pets/accessories/types/petAccessory.schema";
...
import { publishPetAccessoryAd } from "@/lib/pets/accessories/actions/publishPetAccessoryAd";
import { editPetAccessoryAd } from "@/lib/pets/accessories/actions/editPetAccessoryAd";
...
import {
  ...
  HeroCard,
  SectionCard,
} from "./PetAccessoryPublishForm.styles";
import {
...
interface PetAccessoryPublishFormProps {
  entity?: SerializedPetAccessory;
  formMode: FormMode;
}
const PetAccessoryPublishForm: FC<PetAccessoryPublishFormProps> = ({
  entity,
  formMode,
}) => {
  ...
  const updateAccessoryWithImagesToDelete = editPetAccessoryAd.bind(null, {
  ...
  const [formState, formAction, isPending] = useActionState(
    isCreateMode ? publishPetAccessoryAd : updateAccessoryWithImagesToDelete,
    undefined
  );
  ...
  const [form, fields] = useForm({
    ...
    onValidate: ({ formData }) => {
      ...
      return parseWithZod(updatedFormData, {
        schema: createPetAccessorySchema({
              ...
              >
                <Box>
                  <Heading as="h1" size={{ initial: "6", md: "7" }}>
                    Добавьте аксессуар для питомца
                  </Heading>
                  <Text
                    mt="2"
                    size={{ initial: "3", md: "4" }}
              ...
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Укажите животное, вид и название аксессуара.
                  </Text>
                </Box>
                <Grid
            ...
            <SectionCard variant="surface" size="4">
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Укажите название, цену и подробное описание аксессуара.
                  </Text>
                </Box>
                <Grid
                  columns={{ initial: "1", md: "2" }}
...
export default PetAccessoryPublishForm;
