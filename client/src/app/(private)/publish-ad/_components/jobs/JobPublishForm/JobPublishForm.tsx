...
import {
  ...
  MAX_FILES,
  createJobSchema,
} from "@/lib/jobs/types/job.schema";
...
import { publishJobAd } from "@/lib/jobs/actions/publishJobAd";
...
import { editJobAd } from "@/lib/jobs/actions/editJobAd";
...
interface JobPublishFormProps {
  entity?: SerializedJob;
  formMode: FormMode;
}

const JobPublishForm: FC<JobPublishFormProps> = ({ entity, formMode }) => {
  ...
  const updateJobWithImagesToDelete = editJobAd.bind(null, {
    jobPublicId: entity?.publicId as string,
    imagesToDelete,
    allImagesShouldBeDeleted,
  });

  const [formState, formAction, isPending] = useActionState(
    isCreateMode ? publishJobAd : updateJobWithImagesToDelete,
    undefined
  );
              ...
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Укажите название вакансии и место работы.
                  </Text>
                </Box>
                <Grid
            ...
            <SectionCard variant="surface" size="4">
              <Flex direction="column" gap={{ initial: "4", md: "5" }}>
                <Box>
                  ...
                  <Text color="gray" size="2" mt="2">
                    Подробности и требования помогут выделиться в поиске.
                  </Text>
                </Box>
                <TextAreaField
                  field={description}
                  label="Текст объявления:"
                  placeholder="Опишите вакансию, требования и условия работы"
                  size="3"
